...
<div class="add-container">
    <div class="header-row">
        <a href="{{ route('add.property.ptw') }}" class="btn-back">&lt; Go Back</a>
        <h2 class="page-title">Add New Ticket</h2>
    </div>

    <form action="{{ route('add.ticket.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        
        <div class="form-card ticket-form-card">
            ...
            <div class="form-group">
                ...
                <textarea name="deskripsi" class="form-control" rows="3" required placeholder="Ticket description"></textarea>
            </div>

            <div class="form-group">
                <label>Images</label>
                <div class="ticket-image-upload">
                    <div class="image-box single" onclick="document.getElementById('ticket-file').click()">
                    ...
                    <span class="help-text-inline">Please add a relevant image for this ticket.</span>
                </div>
            </div>
